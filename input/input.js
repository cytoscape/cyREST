...
com.qmino.miredot.restApiSource = {"licenceType":"FREE","projectVersion":"0.2.0-SNAPSHOT","allowUsageTracking":true,"jsonDocHidden":true,"licenceHash":"96920848577151415","licenceErrorMessage":null,"miredotVersion":"1.4.1","validLicence":true,"projectTitle":"RESTful API for Cytoscape v1","projectName":"org.cytoscape.rest.cy-rest","dateOfGeneration":"2014-09-05 18:26:48","jsonDocEnabled":false};
...
com.qmino.miredot.restApiSource.tos["org_cytoscape_rest_internal_model_CyNetworkWrapper_in"].comment = null;
...
com.qmino.miredot.restApiSource.tos["org_cytoscape_rest_internal_model_CyNetworkWrapper_out"].comment = null;
...
com.qmino.miredot.restApiSource.interfaces = [
	...
	},
	{
		...
		"produces": ["application/json; charset=UTF-8"],
		"roles": [],
		"output": {"typeValue": { "type": "collection", "typeValue":com.qmino.miredot.restApiSource.tos["org_cytoscape_rest_internal_model_CyNetworkWrapper_out"] }, "comment": "Matched networks in Cytoscape.js JSON. If no query is given, all networks."},
		"statusCodes": [
                { "httpCode": 200, "comment": "The service call has completed successfully."},
                { "httpCode": 500, "comment": "The API call has not succeeded."}
            ],
	...
	{
		"beschrijving": "Create a new, empty column in an assigned table.",
		"url": "/v1/networks/{networkId}/tables/{tableType}/columns",
		"http": "POST",
		"title": "Create new column in the table",
		"tags": [],
		"authors": [],
		"compressed": false,
		"deprecated": false,
	...
	},
	{
		...
		"produces": ["application/json;charset=utf-8"],
		"roles": [],
		"output": {"typeValue": com.qmino.miredot.restApiSource.tos["org_cytoscape_rest_internal_model_CyNetworkWrapper_out"], "comment": "Network with all associated tables in Cytoscape.js format."},
		"statusCodes": [
                { "httpCode": 200, "comment": "The service call has completed successfully."},
                { "httpCode": 500, "comment": "The API call has not succeeded."}
            ],
