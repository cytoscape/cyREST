...
public class LayoutModel {
	@ApiModelProperty(value="Unique internal name of Layout")
	public String name;
	@ApiModelProperty(value="Human-readable name of Layout. This can be seen primarily in the Cytoscape GUI")
