...
import org.cytoscape.rest.internal.NetworkSync;
...
public class EdgeListReaderTest {
	...
	private EdgeListReader readFile(final String fileName) throws Exception {
		...
		EdgeListReader snvp = new EdgeListReader(new FileInputStream(f), viewFactory, netFactory,
				this.networkManager, this.rootNetworkManager);
